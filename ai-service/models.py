...
This is the single source of truth for the JSON shape shared with the Kotlin
backend. Keep it in lockstep with the Kotlin DTOs — the WireMock stubs on the
Kotlin side assert against exactly this shape.
